                                ...
                                leads.results.map((lead, vocabulary, index) => {
                                    return (
                                        <>
                                        {
                                            ...
                                            <StyledTableCell align="center">{getDateFormat(lead.date_of_calling)}</StyledTableCell>
                                            ...
                                            <StyledTableCell align="center">{getDateFormat(lead.vocab_interview_date)}</StyledTableCell>

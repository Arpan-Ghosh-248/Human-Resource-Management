...
import { candiadteStatusOption, interviewStatusOption, vocabResultOption,leadStatusOption } from '../../constants';
    ...
    useEffect(() => {
        if (id) {
            LeadRequest.find(id).then(res => {
                setLead({
                    ...res,
                    calling_recruiter: res.calling_recruiter
                        ? { key: res.calling_recruiter.id, value: res.calling_recruiter.user_name }
                        : null
                });
        ...
        <>
            ...
            <Grid container spacing={2} marginBottom={2}>
                ...
                <CustomSearchSelect
                        ...
                        onTextChange={e => getUsers({ user_name: e && e.target.value })}
            ...
            <Grid container spacing={2} marginBottom={2}>
                ...
                <Grid item xs={4}>
                    <CustomTextArea
                        label="Review"
                        name="vocab_review"
                        error={!!errors.vocab_review}
                        helperText={errors.vocab_review}
                        value={lead.vocab_review}
                        onChange={handleOnchange}
                    />
                </Grid>
            </Grid>
